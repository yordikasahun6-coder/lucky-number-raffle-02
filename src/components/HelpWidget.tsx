    ...
    <>
      ...
      >
        <div className="relative w-14 h-14">
          {!open && <span className="widget-pulse-ring" />}
          <button
            onClick={() => !dragging && setOpen(!open)}
            className={`press-scale relative w-14 h-14 rounded-full bg-[#0F5132] border-2 border-[#E0A72E] flex items-center justify-center shadow-xl shadow-black/30 cursor-grab active:cursor-grabbing ${!open ? "widget-pulse-btn" : ""}`}
          >
            {open ? (
